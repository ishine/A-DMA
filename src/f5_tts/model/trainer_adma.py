            ...
            for batch in current_dataloader:
                ...
                if self.accelerator.is_local_main_process:
                    ...
                    if self.logger == "tensorboard":
                        ...
                        self.writer.add_scalar("diff_loss", diff_loss.item(), global_update)
                        self.writer.add_scalar("proj_loss", proj_loss.item(), global_update)
                        self.writer.add_scalar("ctc_loss", ctc_loss.item(), global_update)
